...
export const defaultEventsData: EventItem[] = [
  {
    ...
    descImaegsList: [
      {
        fileName: "t2_c1_전공방황_1.webp",
        desc: "데이터사이언스 강의 시간",
        fileType: "IMG",
      },
      {
        fileName: "t2_c1_전공방황_2.webp",
        desc: "해커톤 대회",
        fileType: "IMG",
      },
      {
        fileName: "t2_c1_전공방황_3.webp",
        desc: "해커톤 대회 밤샘 현장",
        fileType: "IMG",
      },
      {
        fileName: "t2_c1_전공방황_4.webp",
        desc: "해커톤 서비스 소개",
        fileType: "IMG",
      },
      {
        fileName: "t2_c1_전공방황_5.webp",
        desc: "해커톤 장려상 수상 기념",
        fileType: "IMG",
      },
      {
        fileName: "t2_c1_전공방황_6.webp",
        desc: "교내 AWS 수료증",
        fileType: "IMG",
      },
      {
        fileName: "t2_c1_전공방황_7.webp",
        desc: "알고리즘 강의",
        fileType: "IMG",
      },
      {
        fileName: "t2_c1_전공방황_8.webp",
        desc: "시스템 디자인 강의시간",
        fileType: "IMG",
      },
      {
        fileName: "t2_c1_전공방황_9.webp",
        desc: "어려운 컴공 강의 속에서..",
        fileType: "IMG",
      },
    ],
    repImgFileName: "t2_c1_전공방황_1.webp",
    repImgFileType: "IMG",
    keyWord: "전공방황",
    descImagesList: [],
  },
  {
    ...
    descImaegsList: [
      {
        fileName: "t2_c2_웅장한학회생활_1.webp",
        desc: "데이터분석 학회에서 만든 그래프",
        fileType: "IMG",
      },
      {
        fileName: "t2_c2_웅장한학회생활_2.webp",
        desc: "내가 들어간 금융 데이터 학회 포스터",
        fileType: "IMG",
      },
      {
        fileName: "t2_c2_웅장한학회생활_3.webp",
        desc: "토요일 아침마다 모여서 공부하는 학회원들",
        fileType: "IMG",
      },
      {
        fileName: "t2_c2_웅장한학회생활_4.webp",
        desc: "통계학 수업까지 신청하는 경지..",
        fileType: "IMG",
      },
      {
        fileName: "t2_c2_웅장한학회생활_5.webp",
        desc: "통계학 공부에 빠진(?) 나",
        fileType: "IMG",
      },
    ],
    repImgFileName: "t2_c2_웅장한학회생활_1.webp",
    repImgFileType: "IMG",
    keyWord: "데이터학회",
    descImagesList: [],
  },
  {
    ...
    descImaegsList: [
      {
        fileName: "t2_c1_휴학_1.webp",
        desc: "개발하다 보니 맥북에 이름을 붙여준다",
        fileType: "IMG",
      },
      {
        fileName: "t2_c1_휴학_2.webp",
        desc: "내가 자바스크립트 책을 읽다니..",
        fileType: "IMG",
      },
      {
        fileName: "t2_c1_휴학_3.webp",
        desc: "학기 때보다 더 열심히 공부했다",
        fileType: "IMG",
      },
      {
        fileName: "t2_c1_휴학_4.webp",
        desc: "아침 루틴까지 섭렵한 개발 공부",
        fileType: "IMG",
      },
    ],
    repImgFileName: "t2_c1_휴학_1.webp",
    repImgFileType: "IMG",
    keyWord: "휴학",
    descImagesList: [],
  },
  {
    ...
    descImaegsList: [
      {
        fileName: "t2_c3_스타트업_1.webp",
        desc: "개발 많이 할 각오로 장만한 기계식 키보드",
        fileType: "IMG",
      },
      {
        fileName: "t2_c3_스타트업_2.webp",
        desc: "밤늦게까지 강의 들으며 공부함",
        fileType: "IMG",
      },
      {
        fileName: "t2_c3_스타트업_3.webp",
        desc: "나야~ ",
        fileType: "IMG",
      },
      {
        fileName: "t2_c3_스타트업_4.webp",
        desc: "초보들끼리 로직 고민고민...",
        fileType: "IMG",
      },
      {
        fileName: "t2_c3_스타트업_5.webp",
        desc: "첫 서비슨데 벌써 분석 서비스를 ",
        fileType: "IMG",
      },
      {
        fileName: "t2_c3_스타트업_6.webp",
        desc: "한땀한땀 디자인하고 개발한 화면들",
        fileType: "IMG",
      },
    ],
    repImgFileName: "t2_c3_스타트업_1.webp",
    repImgFileType: "IMG",
    keyWord: "스타트업",
    descImagesList: [],
  },
  ...
  },
  {
    ...
    descImaegsList: [
      {
        fileName: "t3_c2_상태관리_1.webp",
        desc: "신기한 최신 라이브러리 기술의 발전 속도에 감탄하다",
        fileType: "IMG",
      },
    ],
    repImgFileName: "t3_c2_상태관리_1.webp",
    repImgFileType: "IMG",
    keyWord: "React-Query",
    descImagesList: [],
  },
  ...
  },
  {
    ...
    descImaegsList: [
      {
        fileName: "t4_c5_앱안의웹_1.jpg",
        desc: "네이티브 개발자 vs 프론트엔드 개발자",
        fileType: "IMG",
      },
    ],
    repImgFileName: "t4_c5_앱안의웹_1.jpg",
    repImgFileType: "IMG",
    keyWord: "앱안의 웹",
    descImagesList: [],
  },
  {
    ...
    descImaegsList: [
      {
        fileName: "t4_c6_카드_1.jpg",
        desc: "카드금융 비즈니스 이해하기",
        fileType: "IMG",
      },
    ],
    repImgFileName: "t4_c6_카드_1.jpg",
    repImgFileType: "IMG",
    keyWord: "카드금융",
    descImagesList: [],
  },
  {
    ...
    descImaegsList: [
      {
        fileName: "t4_c6_도메인_1.jpg",
        desc: "카드금융 비즈니스 이해하기",
        fileType: "IMG",
      },
    ],
    repImgFileName: "t4_c6_도메인_1.jpg",
    repImgFileType: "IMG",
    keyWord: "도메인",
    descImagesList: [],
  },
  {
    ...
    descImaegsList: [
      {
        fileName: "t4_c5_배포_1.jpg",
        desc: "프로세스대로 하면 되지만 매번 긴장되는 배포",
        fileType: "IMG",
      },
    ],
    repImgFileName: "t4_c5_배포_1.jpg",
    repImgFileType: "IMG",
    keyWord: "배포",
    descImagesList: [],
  },
  {
    ...
    descImaegsList: [
      {
        fileName: "t4_c5_리뉴얼_1.jpg",
        desc: "불가능할 것만 같던 앱 리뉴얼",
        fileType: "IMG",
      },
    ],
    repImgFileName: "t4_c5_리뉴얼_1.jpg",
    repImgFileType: "IMG",
    keyWord: "리뉴얼",
    descImagesList: [],
  },
